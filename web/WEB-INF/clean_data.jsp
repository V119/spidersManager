          ...
          $.post("TableServerlet",
              ...
              function (data, status) {
                  ...
                  for(var i=0;i<headObj.length;i++){    //遍历data数组
                      ...
                      html +="<th align=\"center\" role=\"columnheader\" rowspan=\"1\" colspan=\'1\' tabindex=\"0\"  bgcolor=\'#ffe4c4\' onclick=\"getHeadTag(\'"+headLs+"\',\'"+i+"\\')\">"+headLs+"</th>";
                  }
                  html =html+"</tr></thead>";
                        ...
                        <%--</select>--%>
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li onclick="loseData(1)">填充为NULL</li>
                              <li onclick="loseData(2)">填充均值</li>
                              <li onclick="loseData(3)">填充频繁值</li>
                              <li class="divider"></li>
                              <li onclick="loseData(4)">填充特定的值</li>
                            </ul>
                          </div>
                          <div class="btn-group">
