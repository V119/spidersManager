package com.sicdlib.util.stockUtil.process;
...
//    }
     ...
     *     edges -- 边
     */
    public Dijkstra_process(String[] vexs, EData[] edges) {
    ...
    public static void main(String[] args) {
        ...
        //pG = new ListUDG();
        // 采用已有的"图"
        pG = new Dijkstra_process(vexs, edges);
